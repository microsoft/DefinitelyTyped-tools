 ...
 */
export type TypeScriptVersion = "3.4" | "3.5" | "3.6" | "3.7" | "3.8" | "3.9" | "4.0" | "4.1" | "4.2" | "4.3";
...
export namespace TypeScriptVersion {
  ...
  export const shipped: readonly TypeScriptVersion[] = ["3.4", "3.5", "3.6", "3.7", "3.8", "3.9", "4.0", "4.1"];
  /** Add to this list when a version is available as typescript@next */
  export const supported: readonly TypeScriptVersion[] = [...shipped, "4.2", "4.3"];
